    ...
    <div class="relative bg-primary-600 py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-xl text-primary-100">Get in touch with us. We'd love to hear from you.</p>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="message" name="message" rows="6" class="form-textarea w-full" required></textarea>
                            </div>
                        ...
                        <div class="space-y-8">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">123 Charity Street<br>New York, NY 10001<br>United States</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">info@charity.org<br>support@charity.org</p>
                                </div>
                            </div>
